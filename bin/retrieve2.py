...
def submit_hpss_job(tarfiles, images, job_script_destination, frame_destination, log_destination, tape_number):
    ...
    nersc_account = 'ulens'#os.getenv('NERSC_ACCOUNT')
...
def retrieve_images(whereclause, exclude_masks=False, job_script_destination=None, frame_destination='.',
    ...
    for tape, group in ordered.groupby('tape'):
        ...
        print(tarnames,images,job_script_destination, frame_destination, log_destination, tape)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--frame-destination', default='.', type=str,
                        help='Frame destination')
    args = parser.parse_args()
    retrieve_images(args.whereclause, exclude_masks=args.exclude_masks, frame_destination=args.frame_destination, job_script_destination=args.frame_destination, log_destination=args.frame_destination)
