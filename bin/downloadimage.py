...
for band in ['r','g']:
    ...
    images=glob.glob(directory+'/images/*sciimg.fits')
...
for fieldid,fil,ccd,q in zip(table['field'],table['filtercode'],table['ccdid'],table['qid']):
    ...
    if fil=='zi':
        continue
    if fil=='zg':
        directory='/global/cscratch1/sd/cwar4677/'+src+'_'+'g/tractor'
        fid='1'
    elif fil=='zr':
        fid='2'
        directory='/global/cscratch1/sd/cwar4677/'+src+'_'+'r/tractor'
        print(directory,directory.strip('tractor'))
