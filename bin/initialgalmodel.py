...
if panstarrs=='yes':
    ...
    sciimgs=glob.glob(directory+'/images/*stk.*.unconv.fits')
    ...
    fns=glob.glob(directory+'/images/*stk.*.unconv.mask.fits')
    ...
    fns=glob.glob(directory+'/images/*stk.*.unconv.wt.fits')
